...
// #define LTE_RRC_BCCH_BCH_NB                  (WS_LTE_PROTOCOL | 0x002C)
// #define LTE_RRC_BCCH_DL_SCH_NB               (WS_LTE_PROTOCOL | 0x002D)
// #define LTE_RRC_PCCH_NB                      (WS_LTE_PROTOCOL | 0x002E)
// #define LTE_RRC_DL_CCCH_NB                   (WS_LTE_PROTOCOL | 0x002F)
// #define LTE_RRC_DL_DCCH_NB                   (WS_LTE_PROTOCOL | 0x0030)
// #define LTE_RRC_UL_CCCH_NB                   (WS_LTE_PROTOCOL | 0x0031)
// #define LTE_RRC_SC_MCCH_NB                   (WS_LTE_PROTOCOL | 0x0032)
// #define LTE_RRC_UL_DCCH_NB                   (WS_LTE_PROTOCOL | 0x0033)
...
void start_ws_trace();
void send_ws_log(unsigned short msg_type, unsigned short rnti, unsigned char *msg_buf, unsigned short msg_len);
void stop_ws_trace();
